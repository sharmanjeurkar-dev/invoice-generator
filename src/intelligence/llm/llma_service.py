...
# 2. Configure the Google GenAI SDK
client = OpenAI(
...
def generate_json_for_invoice_from_prompt(query: str) -> dict:
    ...
    print("\n--- SENDING PROMPT TO llma-3.1-8B-instruct ---")

    max_retries = 3
    raw_content = ""

    # Exponential Backoff Loop for Free Tier Rate Limits
    ...
    # Strip markdown block formatting that Gemma often includes
...
# Keeping this alias in case your test scripts use the shorter name
